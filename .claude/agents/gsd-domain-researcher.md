...
<required_reading>
Read `/Users/ducph/godot/my-demon/packages/akc-service/.claude/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
