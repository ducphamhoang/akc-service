...
<reference>
@/Users/ducph/godot/my-demon/packages/akc-service/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/ducph/godot/my-demon/packages/akc-service/.claude/get-shit-done/references/user-profiling.md` to load:
