...
<required_reading>
Read `/Users/ducph/godot/my-demon/packages/akc-service/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
