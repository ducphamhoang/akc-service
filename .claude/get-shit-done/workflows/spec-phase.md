...
```bash
INIT=$(node "/Users/ducph/godot/my-demon/packages/akc-service/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/ducph/godot/my-demon/packages/akc-service/.claude/get-shit-done/templates/spec.md.
