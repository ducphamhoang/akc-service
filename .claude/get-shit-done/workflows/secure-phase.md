...
```
Task(
  prompt="Read /Users/ducph/godot/my-demon/packages/akc-service/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/ducph/godot/my-demon/packages/akc-service/.claude/get-shit-done/templates/SECURITY.md`
