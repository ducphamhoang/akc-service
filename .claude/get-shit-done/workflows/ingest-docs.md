...
```bash
INIT=$(node "/Users/ducph/godot/my-demon/packages/akc-service/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/ducph/godot/my-demon/packages/akc-service/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
