...
<required_reading>
@/Users/ducph/godot/my-demon/packages/akc-service/.claude/get-shit-done/references/ai-frameworks.md
@/Users/ducph/godot/my-demon/packages/akc-service/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/ducph/godot/my-demon/packages/akc-service/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/ducph/godot/my-demon/packages/akc-service/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/ducph/godot/my-demon/packages/akc-service/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/ducph/godot/my-demon/packages/akc-service/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/ducph/godot/my-demon/packages/akc-service/.claude/agents/gsd-eval-planner.md for instructions.
