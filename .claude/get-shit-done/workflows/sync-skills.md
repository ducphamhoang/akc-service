...
INSTALL_JS_GLOBAL="/Users/ducph/godot/my-demon/packages/akc-service/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/ducph/godot/my-demon/packages/akc-service/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
