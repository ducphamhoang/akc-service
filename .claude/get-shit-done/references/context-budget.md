...
The keys live in `.claude/settings.json` (project) or `/Users/ducph/godot/my-demon/packages/akc-service/.claude/settings.json` (global) — **not** in `.planning/config.json`:
