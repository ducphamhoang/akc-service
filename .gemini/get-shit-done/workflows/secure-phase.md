...
```
Task(
  prompt="Read /Users/ducph/godot/my-demon/packages/akc-service/.gemini/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/ducph/godot/my-demon/packages/akc-service/.gemini/get-shit-done/templates/SECURITY.md`
