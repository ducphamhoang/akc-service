...
- **Global scope**: `/Users/ducph/godot/my-demon/packages/akc-service/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/ducph/godot/my-demon/packages/akc-service/.gemini/notes/`)
...
2. Glob `/Users/ducph/godot/my-demon/packages/akc-service/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (/Users/ducph/godot/my-demon/packages/akc-service/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/ducph/godot/my-demon/packages/akc-service/.gemini/notes/` — works in any directory
