...
The keys live in `.codex/settings.json` (project) or `/Users/ducph/godot/my-demon/packages/akc-service/.codex/settings.json` (global) — **not** in `.planning/config.json`:
